...
(function () {
  ...
  // تأكد من أن الملف يتم تحميله بعد تحميل الصفحة
// document.addEventListener('DOMContentLoaded', function () {
//   // حدد عنصر الرسم البياني
//   const profileReportChartEl = document.querySelector('#profileReportChart');

//   // تأكد من وجود العنصر قبل المتابعة
//   if (profileReportChartEl) {
//       // جلب البيانات من دالة GET
//       axios.get('/reports/stock') // استخدم المسار الذي قمت بتحديده
//           .then(function (response) {
//               // تأكد من الحصول على البيانات بنجاح
//               const purchaseData = response.data.purchaseData;
//               const salesData = response.data.salesData;
//               const returnsData = response.data.returnsData;
//               const dateLabels = response.data.dateLabels;
...
//                           left: 5,
//                           blur: 3,
//                           color: '#FFC107', // يمكنك استخدام color من config.colors.warning
//                           opacity: 0.15
//                       },
//                       sparkline: {
//                           enabled: true
...
//                       }
//                   },
//                   colors: ['#FFC107'], // لون الرسم البياني
//                   dataLabels: {
//                       enabled: false
//                   },
//                   stroke: {
...
// تحقق من وجود العنصر قبل إنشاء الرسم
if (profileReportChartEl) {
    const profileReportChart = new ApexCharts(profileReportChartEl, profileReportChartConfig);
    profileReportChart.render();
}
